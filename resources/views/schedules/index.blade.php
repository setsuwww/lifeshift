...
<a href="{{ route('schedules.create') }}" class="px-3 py-2 bg-green-600 text-white rounded">+ New</a>
...
<table class="w-full mt-4 border">
    ...
    <tbody>
        ...
        <tr>
            <td class="border px-2 py-1">{{ $schedule->title }}</td>
            <td class="border px-2 py-1">{{ $schedule->date }}</td>
